...
class Vc_Gitem_Acf_Shortcode extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		// $field_group = ID do grupo de campos personalizados do ACF (neste caso estou pegando o id do grupo do campo 'Fotos Cards')
		// $fields_group = ID of the ACF field groups 
